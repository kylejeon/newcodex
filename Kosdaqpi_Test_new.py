...
# 강추세 기반 업사이드 노출 오버레이
EXPO_UP_MAX_DD = float(os.getenv("EXPO_UP_MAX_DD", "-0.06"))
EXPO_UP_RATE = float(os.getenv("EXPO_UP_RATE", "1.10"))
EXPO_UP2_MAX_DD = float(os.getenv("EXPO_UP2_MAX_DD", "-0.03"))
EXPO_UP2_RATE = float(os.getenv("EXPO_UP2_RATE", "1.18"))
...
for date in combined_df.index.unique():
    ...
    if CurrentDD >= EXPO_UP2_MAX_DD and IsVeryStrongTrend == True:
        ExposureRate = EXPO_UP2_RATE
    elif CurrentDD >= EXPO_UP_MAX_DD and IsStrongTrend == True:
